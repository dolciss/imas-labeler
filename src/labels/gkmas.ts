...
export const GKMAS_LABELS: Label[] = [
    ...
    locales: [
      {
        ...
        name: '葛城リーリヤ',
        description:
          '海外出身の新入生。歌やダンスの経験はなく、いつも自信がなさそうに縮こまっている。才能があるようには見えないが、アイドルへの憧れは本物で、相当な努力家。親友의 清夏とは、一緒にステージに立つ約束をしている。',
      },
    ...
    locales: [
      {
        ...
        name: '雨夜燕',
        description:
          '初星学園生徒会副会長。学園No.2のアイドル。実力相応のプライドを持ち、尊大な態度を取る。自分にも他人にも厳しいが、面倒見は良い。幼馴染の星南をライバル視しており、いずれ星南を超えて『一番星』になると公言している。',
      },
    ...
    locales: [
      {
        ...
        name: '賀陽燐羽',
        description:
          '中等部ナンバーワンユニット『SyngUp!』の元リーダー。初星学園の特待生として1年3組に所属していた。961プロに移籍し、極月学園のアイドルとして『NEXT IDOL AUDITION』に参加する。',
      },
    ...
    locales: [
      {
        ...
        name: '藍井撫子',
        description:
          '極月学園の1年生。学内上位層であるBランクアイドル。裕福な実家の力を活用し、多くのファンを獲得してきた。両親に溺愛されて育ったことから容姿に圧倒的な自信を持っている。四音のことを「お姉さま」と呼び、慕っているが、利用されている自覚はない。',
      },
    ...
    locales: [
      {
        ...
        name: '白草四音',
        description:
          '極月学園の1年生。Aランクに君臨するアイドル。ボーカル、ビジュアル、ダンス、すべての能力が一級品。普段は物腰柔らかで猫を被っているが、その本性は冷徹にして残忍。アイドルは手段であり、ファンは道具。他者を蹴落とすことで成り上がってきた。',
      },
    ...
    locales: [
      {
        ...
        name: '白草月花',
        description:
          '極月学園の3年生。学内で唯一人のSランク。すでにトップアイドルと名高く、現在はアメリカを中心に活躍中。無駄を嫌い、大抵の人間に興味がない。名を覚えるのは、才ある者のみ。クールな外見と傑出したパフォーマンスを売りにしており、海外の女性ファンが多い。',
      },
  ...
  {
    rkey: '3mcgnlc4dh22c',
    identifier: 'unit-reiris',
    locales: [
      {
        lang: 'ja',
        name: 'Re;IRIS',
        description:
          '初星学園アイドル科に所属する花海咲季、月村手毬、藤田ことねの3人で結成されたユニット「Re;IRIS」。ユニット名の「Re:IRIS」は、英語で「再び」を意味する接頭辞「Re」と、アヤメの英名「Iris（アイリス）」、虹の女神「Iris（イーリス）」に由来しており、「花のように不屈で、女神のように歌い、虹のように希望を返す」アイドルになろうという思いで名付けられた。',
      },
  ...
  {
    rkey: '3mcgnlgxwws2c',
    identifier: 'unit-begrazia',
    locales: [
      {
        lang: 'ja',
        name: 'Begrazia',
        description: '初星学園アイドル科に所属する花海佑芽、秦谷美鈴、十王星南の3人で結成されたユニット。',
      },
  ...
  {
    rkey: '3mcgnllsrzc2c',
    identifier: 'unit-syngup',
    locales: [
      {
        lang: 'ja',
        name: 'SyngUp!',
        description: '初星学園アイドル科に所属する月村手毬、秦谷美鈴、賀陽燐羽の3人で結成されていたユニット。',
      },
  ...
  {
    rkey: '3mcgnlqo4ps2c',
    identifier: 'unit-yumepathy',
    locales: [
      {
        lang: 'ja',
        name: 'ゆめぱしー',
        description: '初星学園アイドル科に所属する倉本千奈、篠澤広の2人で結成されたユニット。',
      },
